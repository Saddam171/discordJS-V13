...
module.exports = {
  ...
  aliases:["clear","limpar"],
    ...
    return message.reply("<:K_zan:924366252024164363>  eu tou sem ah permissão de `ADMINISTRADOR` infelizmente sou inútil")
  }
            ...
            if (parseInt(delamount) > 1000) return message.reply('Acho que você que apagar além do que eu posso, apago de **2 a 99 messagens**, sorry')
